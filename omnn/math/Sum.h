...
namespace omnn::math {
    ...
    using sum_cont = std::set<Valuable, SumOrderComparator>;

class Sum : public ValuableCollectionDescendantContract<Sum, sum_cont> {
private:
...
public:
    ...
    std::vector<Valuable> Coefficients(const Variable& va) const;
