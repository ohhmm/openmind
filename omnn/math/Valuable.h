...
struct equal_to<::omnn::math::Valuable> {
    bool operator()(const ::omnn::math::Valuable& valuable1, const ::omnn::math::Valuable& valuable2) const;
};
...
::omnn::math::Valuable operator"" _v(const char* valuable, std::size_t);
const ::omnn::math::Variable& operator"" _va(const char* valuable, std::size_t);
//constexpr
::omnn::math::Valuable operator"" _v(unsigned long long valuable);
//constexpr const ::omnn::math::Valuable& operator"" _const(unsigned long long valuable);
::omnn::math::Valuable operator"" _v(long double valuable);
