...
namespace {
    ...
    // SumOrderComparator implementation moved to SumOrderComparator.cpp
    ...
    bool Sum::IsComesBefore(const Valuable& v) const
    {
        if (v.IsSum()) {
            ...
            for (auto i1 = beg, i2 = sbeg; i1 != end(); ++i1, ++i2) {
                if (*i1 != *i2) {
                    auto cmp12 = SumOrderComparator::toc(*i1, *i2);
                    auto cmp21 = SumOrderComparator::toc(*i2, *i1);
                    if (cmp12 == cmp21)
                        continue;
                    return cmp21;
                }
            ...
            for (auto i1 = beg, i2 = sbeg; i1 != end(); ++i1, ++i2) {
                if (*i1 != *i2) {
                    return SumOrderComparator::toc(*i1, *i2);
                }
            }
        }
        ...
        return SumOrderComparator::toc(*this, v);
    }
