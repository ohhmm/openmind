...
namespace math {
    ...
    protected:
        ...
        [[nodiscard]] auto CPtr() const noexcept {
        ...
        [[nodiscard]] Chld& Ref() noexcept {
            return *Ptr();
        }

        [[nodiscard]] const Chld& CRef() noexcept {
            return Ref();
        }
        ...
        [[nodiscard]] size_t getTypeSize() const override { return sizeof(Chld); }
