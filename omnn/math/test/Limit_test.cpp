...
BOOST_AUTO_TEST_CASE(Limit_indeterminate_form_test) {
...
BOOST_AUTO_TEST_CASE(Limit_infinity_form_test, *disabled()) {
...
BOOST_AUTO_TEST_CASE(Limit_derivative_test, *disabled()) {
