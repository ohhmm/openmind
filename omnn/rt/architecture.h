 ...
 */
inline constexpr Architecture GetCurrentArchitecture() {
 ...
 */
inline constexpr const char* GetArchitectureName(Architecture arch) {
    switch (arch) {
 ...
 */
inline constexpr bool IsX86Architecture() {
 ...
 */
inline constexpr bool IsArmArchitecture() {
    const auto arch = GetCurrentArchitecture();
