	...
	if(NOT ${dep}_FOUND)
		...
		elseif(OPENMIND_USE_PKG_CONFIG_DEPS)
			...
			if(PKG_FOUND)
				...
				target_link_libraries(${this_target} ${visibility} PkgConfig::${underscored_down})
			else()
	...
	if(${dep}_FOUND)
		...
		if(this_target)
			if(${dep}_INCLUDE_DIR)
				...
				target_include_directories(${this_target} ${visibility} ${${dep}_INCLUDE_DIR})
			endif()
			if(${dep}_INCLUDE_DIRS)
				message("${dep}_INCLUDE_DIRS: ${${dep}_INCLUDE_DIRS} for ${this_target}")
				target_include_directories(${this_target} ${visibility} ${${dep}_INCLUDE_DIRS})
			endif()
		endif()
		if(${dep}_LIBRARY)
			if(this_target)
				target_link_libraries(${this_target} ${visibility} ${${dep}_LIBRARY})
			endif()
		...
		if(${dep}_LIBRARIES)
			...
			if(repo)
				...
				if(repo STREQUAL "SYSTEM")
					...
					if(this_target)
						target_link_libraries(${this_target} ${visibility} ${${dep}_LIBRARIES})
					endif()
				else()
