...
if(OPENMIND_USE_CPACK)
	...
	pkgwith(rpm)
    pkgwith(deb)
	option(CPACK_SOURCE_RPM "Sources" NO)
	option(CPACK_SOURCE_TBZ2 "Sources" NO)
	option(CPACK_SOURCE_TGZ "Sources" NO)
	option(CPACK_SOURCE_TXZ "Sources" NO)
	option(CPACK_SOURCE_TZ "Sources" NO)
	option(CPACK_SOURCE_ZIP "Sources" NO)
	option(CPACK_BINARY_TZ "Binaries in archive" NO)
	option(CPACK_BINARY_TGZ "Binaries in archive" NO)
	option(CPACK_BINARY_STGZ "Binaries in archive" NO)
endif()
