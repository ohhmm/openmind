...
macro(glob_add_dir_source_files)
	...
	if (IS_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/${ARGN}
    	...
    	unset(${varnameprefix}dir_src)
		unset(${varnameprefix}dir_resources)
		unset(${varnameprefix}dir_qtsrc)
		unset(${varnameprefix}dir_qmlsrc)
		unset(${varnameprefix}dir_pcs)
		unset(${varnameprefix}dir_pch)
		unset(${varnameprefix}dir_headers)
	endif()
